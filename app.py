...
st.markdown(f'### Historical Data from 2013 to 2021')
...
with col8:
    ...
    fig = px.line(by_year_and_boro, x="crash_month", y=metric, color='crash_year', markers=True, title=f'{proper_metric} between 2012 and 2021 <br><sup>Data may not be complete due to missing borough labels.</sup>' , labels={
                        'crash_year': 'Year',
                        "crash_month": 'Month',
